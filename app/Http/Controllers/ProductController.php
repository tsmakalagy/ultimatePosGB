            ...
            return Datatables::of($products)
                ...
                ->addColumn(
                    ...
                    function ($row) use ($selling_price_group_count) {
                        ...
                        if (auth()->user()->can('')) {
                            $html .=
                            '<li><a href="' . action('ProductController@productSell', [$row->id]) . '"><i class="glyphicon glyphicon-edit"></i> ' . __("sell") . '</a></li>';
                        }
 ...
 /**
    ...
    public function productSell($id){
        ...
        if (request()->ajax()) {
            ...
            $sells = $this->transactionUtil->getListSellsWithProducts($business_id, $sale_type,$id);
