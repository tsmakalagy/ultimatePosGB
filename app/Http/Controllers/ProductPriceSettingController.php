...
class ProductPriceSettingController extends Controller
{
    ...
    public function index(){
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of( $price_product)
                ->addColumn(
                    'action',
                    function ($row) use ($only_shipments, $is_admin, $sale_type) {
                        ...
                        if (auth()->user()->can('product.update')) {
                            $html .=
                                '<li><a target="_blank" href="' . action('ProductPriceSettingController@edit', [$row->id]) . '"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</a></li>';
                        }
                        if (auth()->user()->can('sell.delete')) {
                            $html .=
                                '<li><a href="' . action('ProductPriceSettingController@delete', [$row->id]) . '" class="delete-sell"><i class="fa fa-trash"></i> ' . __("messages.delete") . '</a></li>';
                        }
                ...
                ->editColumn('tel',
                    '<span class="tel">   </span>')
                ->editColumn('cours_usd',
                        '<span class="cours_usd" data-orig-value="{{$cours_usd}}">@if(!empty($cours_usd)) {{$cours_usd}} @endif   </span>')
                        ->editColumn('cours_rmb',
                        '<span class="cours_rmb" data-orig-value="{{$cours_rmb}}">@if(!empty($cours_rmb)) {{$cours_rmb}} @endif   </span>')
                        ->editColumn('frais_taxe_usd_bateau',
                        '<span class="frais_taxe_usd_bateau" data-orig-value="{{$frais_taxe_usd_bateau}}">@if(!empty($frais_taxe_usd_bateau)) {{$frais_taxe_usd_bateau}} @endif   </span>')
                        ->editColumn('frais_taxe_usd_avion',
                        '<span class="frais_taxe_usd_avion" data-orig-value="{{$frais_taxe_usd_avion}}">@if(!empty($frais_taxe_usd_avion)) {{$frais_taxe_usd_avion}} @endif   </span>')
                        ->editColumn('frais_usd_bateau',
                        '<span class="frais_usd_bateau" data-orig-value="{{$frais_usd_bateau}}">@if(!empty($frais_usd_bateau)) {{$frais_usd_bateau}} @endif   </span>')
                        ->editColumn('frais_compagnie_usd_bateau',
                        '<span class="frais_compagnie_usd_bateau" data-orig-value="{{$frais_compagnie_usd_bateau}}">@if(!empty($frais_compagnie_usd_bateau)) {{$frais_compagnie_usd_bateau}} @endif   </span>')
                        ->editColumn('constante_taxe',
                        '<span class="constante_taxe" data-orig-value="{{$constante_taxe}}">@if(!empty($constante_taxe)) {{$constante_taxe}} @endif   </span>')
    ...
    public function create()
    {
       ...
       // dd($product_price_setting);
        ...
        return view('product_price_settings.create', compact('product_price_setting'));
    }
    ...
    public function store(Request $request)
    {
            ...
            if($request->filled('cours_rmb','cours_usd')){
                $cours_usd=$request->input('cours_usd');
                $cours_rmb=$request->input('cours_rmb');
                $frais_taxe_usd_bateau=$request->input('frais_taxe_usd_bateau');
                $frais_usd_bateau=$request->input('frais_usd_bateau');
                $frais_compagnie_usd_bateau=$request->input('frais_compagnie_usd_bateau');
                $constante_taxe=$request->input('constante_taxe');
                $frais_taxe_usd_avion=$request->input('frais_taxe_usd_avion');

            
                $price_product= ProductPriceSetting::firstOrCreate(['cours_usd'=> $cours_usd,'cours_rmb'=>$cours_rmb,'constante_taxe'=>$constante_taxe,'frais_taxe_usd_bateau'=>$frais_taxe_usd_bateau,'frais_usd_bateau'=>$frais_usd_bateau,'frais_compagnie_usd_bateau'=>  $frais_compagnie_usd_bateau,'frais_taxe_usd_avion'=> $frais_taxe_usd_avion]);
    ...
    public function edit($id)
    {
       ...
       // $shipper_types = ShipperType::pluck('type', 'id');
        ...
        return view('product_price_settings.edit', compact('price_product'));
