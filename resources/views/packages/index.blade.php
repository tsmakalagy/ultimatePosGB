...
@section('content')
    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-primary'])
                ...
                @slot('tool')
                    <div class="box-tools">
                        <button type="button" class="btn btn-block btn-primary btn-modal"
                            data-href="{{ action('PackageController@scan') }}" data-container=".scan_modal">
            ...
            @endif
        @endcomponent
        <div class="modal product_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        </div>

        <div class="modal " id="view_product_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        </div>
        <div class="modal scan_modal" id="scan_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        </div>
        ...
        $(document).ready(function() {
            ...
            shipper_table = $('#shipper_table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'mode_transport',
                        name: 'packages.mode_transport'
                    },
                    {
                        data: 'commission_agent',
                        name: 'packages.commission_agent'
                    },
                    {
                        data: 'other_field1',
                        name: 'other_field1'
