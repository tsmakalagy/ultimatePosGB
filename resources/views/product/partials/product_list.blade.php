    ...
    <tr>
        <td colspan="{{$colspan}}">
            <div style="display: flex; width: 100%;">
                ...
                @can('product.create')
                    &nbsp;
                    {!! Form::open(['url' => action('ImportProductsController@exportToCSV'), 'method' => 'post', 'id' => 'export_form' ]) !!}
                    {!! Form::hidden('selected_products', null, ['id' => 'selected_products_for_export']); !!}
                    <button type="submit" class="btn btn-xs btn-primary" id="export-selected"> Exporter</button>
                    {!! Form::close() !!}
                @endcan
