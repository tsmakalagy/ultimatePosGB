<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <input id="hide_cu" name="invisible" type="number" value="{{$product_price_setting->cours_usd}}"
               style="display: none">
        <input id="hide_fub" name="invisible" type="number" value="{{$product_price_setting->frais_usd_bateau}}"
               style="display: none">
        <input id="hide_cr" name="invisible" type="number" value="{{$product_price_setting->cours_rmb}}"
               style="display: none">
        <input id="hide_ct" name="invisible" type="number" value="{{$product_price_setting->constante_taxe}}"
               style="display: none">
        <input id="hide_fcub" name="invisible" type="number"
               value="{{$product_price_setting->frais_compagnie_usd_bateau}}" style="display: none">
        <input id="hide_ftub" name="invisible" type="number" value="{{$product_price_setting->frais_taxe_usd_bateau}}"
               style="display: none">
