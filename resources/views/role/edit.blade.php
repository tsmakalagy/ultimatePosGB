...
<!-- note : changer la class input ichec pour afficher les checkbox -->
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9 col-md-offset-1">
          ...
          <div class="checkbox">
            <label>
              ...
              [ 'class' => 'input-ichec']); !!} {{ __( 'restaurant.service_staff' ) }}
            </label>
        ...
        <div class="col-md-2">
            <div class="checkbox">
              <label>
                <input type="checkbox" class="check_all input-ichec" > {{ __( 'role.select_all' ) }}
              </label>
            </div>
        </div>
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.user.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.user.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.user.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.user.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_role' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.add_role' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.edit_role' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_role' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'can_see_more_dashboard',  in_array('can_see_more_dashboard', $role_permissions), 
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.see_more_dashboard' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_supplier' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_supplier' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.supplier.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.supplier.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.supplier.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_customer' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_customer' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.customer_with_no_sell_one_month' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.customer_with_no_sell_three_month' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.customer_with_no_sell_six_month' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.customer_with_no_sell_one_year' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.customer.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.customer.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.customer.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.product.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.product.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.product.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.product.delete' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.add_opening_stock' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_purchase_price', in_array('view_purchase_price', $role_permissions),['class' => 'input-ichec']); !!}
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_purchase_n_stock_adjustment' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[purchase_view]', 'view_own_purchase', in_array('view_own_purchase', $role_permissions),['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.purchase.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.purchase.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.purchase.delete' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.payments', in_array('purchase.payments', $role_permissions),['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.update_status', in_array('purchase.update_status', $role_permissions),['class' => 'input-ichec']); !!}
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_purchase_order' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_purchase_order' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.create_purchase_order' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.edit_purchase_order' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_purchase_order' ) }}
                  </label>
                </div>
              </div>
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'role.sell.view' ) }}
                      </label>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            ...
                            [ 'class' => 'input-ichec']); !!} {{ __( 'role.sell.create' ) }}
                          </label>
                        </div>
                    </div>
                @endif
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'role.sell.update' ) }}
                      </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'role.sell.delete' ) }}
                      </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'edit_product_price_from_pos_screen', in_array('edit_product_price_from_pos_screen', $role_permissions), ['class' => 'input-ichec']); !!}
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'edit_product_discount_from_pos_screen', in_array('edit_product_discount_from_pos_screen', $role_permissions), ['class' => 'input-ichec']); !!}
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'print_invoice', in_array('print_invoice', $role_permissions), ['class' => 'input-ichec']); !!}
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_sale' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_sell_only' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_paid_sells_only' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_due_sells_only' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_partially_paid_sells_only' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_overdue_sells_only' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.add_sell' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.update_sale' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_sell' ) }}
              </label>
            </div>
          </div>
          @endif
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_commission_agent_sell' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sell.payments', in_array('sell.payments', $role_permissions), ['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'edit_product_price_from_sale_screen', in_array('edit_product_price_from_sale_screen', $role_permissions), ['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'edit_product_discount_from_sale_screen', in_array('edit_product_discount_from_sale_screen', $role_permissions), ['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'discount.access', in_array('discount.access', $role_permissions), ['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.access_types_of_service' ) }}
              </label>
            </div>
          </div>
          @endif
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.access_all_sell_return' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.access_own_sell_return' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.add_edit_invoice_number' ) }}
              </label>
            </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  ...
                  [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_so' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  ...
                  [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_so' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  ...
                  [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.create_so' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  ...
                  [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.edit_so' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  ...
                  [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_so' ) }}
                </label>
              </div>
            </div>
      ...
      <div class="row check_group">
        ...
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-ichec']) !!} {{ __( 'lang_v1.view_all_drafts' ) }}
          </label>
        </div>
      </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_drafts' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.edit_draft' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_draft' ) }}
              </label>
            </div>
          </div>
      ...
      <div class="row check_group">
        ...
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_all_quotations' ) }}
          </label>
        </div>
      </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_own_quotations' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.edit_quotation' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_quotation' ) }}
              </label>
            </div>
          </div>
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::radio('radio_option[shipping_view]', 'access_shipping', in_array('access_shipping', $role_permissions), ['class' => 'input-ichec']); !!}
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::radio('radio_option[shipping_view]', 'access_own_shipping', in_array('access_own_shipping', $role_permissions), ['class' => 'input-ichec']); !!}
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'access_pending_shipments_only', in_array('access_pending_shipments_only', $role_permissions), ['class' => 'input-ichec']); !!}
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'access_commission_agent_shipping', in_array('access_commission_agent_shipping', $role_permissions), ['class' => 'input-ichec']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_cash_register' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.close_cash_register' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.brand.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.brand.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.brand.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.brand.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.tax_rate.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.tax_rate.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.tax_rate.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.tax_rate.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.unit.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.unit.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.unit.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.unit.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.category.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.category.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.category.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.category.delete' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.purchase_n_sell_report.view' ) }}
              </label>
            </div>
          </div>
        @endif
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.tax_report.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.contacts_report.view' ) }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.expense_report.view' ) }}
              </label>
            </div>
          </div>
          @endif
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.profit_loss_report.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.stock_report.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.trending_product_report.view' ) }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.register_report.view' ) }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.sales_representative.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.view_product_stock_value' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.business_settings.access' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.barcode_settings.access' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.invoice_settings.access' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'access_printers', in_array('access_printers', $role_permissions),['class' => 'input-ichec']); !!}
                  ...
                  <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            ...
                            [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.access_all_expense' ) }}
                          </label>
                        </div>
                      </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                      <label>
                        {!! Form::radio('radio_option[expense_view]', 'view_own_expense', in_array('view_own_expense', $role_permissions),['class' => 'input-ichec']); !!}
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'expense.add_expense' ) }}
                      </label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'expense.edit_expense' ) }}
                      </label>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.delete_expense' ) }}
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'role.dashboard.data' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'lang_v1.access_accounts' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'restaurant.add_edit_view_all_booking' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __( 'restaurant.add_edit_view_own_booking' ) }}
              </label>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ __('lang_v1.default_selling_price') }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-ichec']); !!} {{ $selling_price_group->name }}
              </label>
            </div>
          </div>
          @endforeach
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-ichec']); !!} {{ __('lang_v1.access_tables') }}
                  </label>
                </div>
              </div>
            </div>
